    ...
    <div className="border rounded-lg shadow-lg bg-white overflow-hidden">
      ...
      <div className="p-6">
        ...
        <div className="flex justify-between gap-4 items-center mb-4">
          <button
            className="bg-blue-500 text-white font-semibold py-2 px-2 rounded hover:bg-blue-600 transition duration-300"
          ...
          {!favorites.some((fav) => fav.idMeal === meal.idMeal) ? (
            <button
              className="bg-red-500 text-white font-semibold py-2 px-2 rounded hover:bg-red-600 cursor-pointer transition duration-300"
            ...
            <button
              className="bg-red-500 text-white font-semibold py-2 px-2 rounded hover:bg-red-600 transition duration-300"
